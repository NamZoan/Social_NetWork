            ...
            <div class="user-profile">
                <div class="profile-header-background">
                    <a href="#" class="profile-cover">
                        <img
                            :src="'/images/web/users/cover/cover-1.gif'"
                            alt="Profile Header Background"
                        />
                        <div class="cover-overlay">
                            <a href="#" class="btn btn-update-cover"
                                ><i class="bx bxs-camera"></i> Update Cover
                                Photo</a
                            >
                        </div>
                    </a>
                        ...
                        <div class="profile-info-left">
                            <div class="text-center">
                                <div class="profile-img w-shadow">
                                    ...
                                    <img
                                        :src="'/images/web/users/user-4.jpg'"
                                        alt="Avatar"
                                        class="avatar img-circle"
                                    />
                                    <div class="profile-img-caption">
                                        <label
                                            for="updateProfilePic"
                                            class="upload"
                                        >
                            ...
                            <div class="intro mt-5 mv-hidden">
                                ...
                                >
                                    <p class="intro-title text-muted">
                                        <i
                                            class="bx bx-briefcase text-primary"
                                        ></i>
                                        Web Developer at
                                ...
                                >
                                    <p class="intro-title text-muted">
                                        ...
                                        <a href="#"
                                            >Online
                                            <span
                                                class="ml-1 online-status bg-success"
                                            ></span
                                        ></a>
                                    </p>
                                </div>
                            ...
                            <div class="intro mt-5 row mv-hidden">
                                <div class="col-md-4">
                                    <img
                                        :src="'/images/web/users/album/album-1.jpg'"
                                        width="95"
                                        alt=""
                                    />
                                </div>
                                <div class="col-md-4">
                                    <img
                                        :src="'/images/web/users/album/album-2.jpg'"
                                        width="95"
                                        alt=""
                                    />
                                </div>
                                <div class="col-md-4">
                                    <img
                                        :src="'/images/web/users/album/album-3.jpg'"
                                        width="95"
                                        alt=""
                                    />
                                </div>
                            ...
                            <div class="intro mt-5 mv-hidden">
                                ...
                                >
                                    <p class="intro-title text-muted">
                                        <i
                                            class="bx bxl-facebook-square facebook-color"
                                        ></i>
                                        <a href="#" target="_blank"
                                            >facebook.com/username</a
                                        >
                                    </p>
                                </div>
                                <div
                                ...
                                >
                                    <p class="intro-title text-muted">
                                        <i
                                            class="bx bxl-twitter twitter-color"
                                        ></i>
                                        <a href="#" target="_blank"
                                            >twitter.com/username</a
                                        >
                                    </p>
                                </div>
                                <div
                                ...
                                >
                                    <p class="intro-title text-muted">
                                        <i
                                            class="bx bxl-instagram instagram-color"
                                        ></i>
                                        <a href="#" target="_blank"
                                            >instagram.com/username</a
                                        >
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="col-md-8 p-0">
                        <div class="profile-info-right">
                            <div class="col-md-12 profile-center">
                                ...
                                <div
                                    class="post border-bottom p-3 bg-white w-shadow"
                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div class="row">
                                                                ...
                                                                >
                                                                    <i
                                                                        class="bx bx-hide post-option-icon"
                                                                    ></i>
                                                                </div>
                                                                <div
                                                                    class="col-md-10"
                                                        ...
                                                        >
                                                            <div class="row">
                                                                ...
                                                                >
                                                                    <i
                                                                        class="bx bx-time post-option-icon"
                                                                    ></i>
                                                                </div>
                                                                <div
                                                                    class="col-md-10"
                                                        ...
                                                        >
                                                            <div class="row">
                                                                ...
                                                                >
                                                                    <i
                                                                        class="bx bx-block post-option-icon"
                                                                    ></i>
                                                                </div>
                                                                <div
                                                                    class="col-md-10"
                                    ...
                                    <div class="mt-3">
                                        <p>
                                            ...
                                            voluptatem veritatis harum, tenetur,
                                            quibusdam voluptatum, incidunt saepe
                                            minus maiores ea atque sequi illo
                                            veniam sint quaerat corporis totam
                                            et. Culpa?
                                        </p>
                                    </div>
                                    <div class="d-block mt-3">
                                        <img
                                            :src="'/images/web/users/post/post-1.jpg'"
                                            class="w-100 mb-3"
                                            alt="post image"
                                        />
                                    </div>
                                    <div class="mb-2">
                                        ...
                                        <div class="argon-reaction">
                                            <span class="like-btn">
                                                ...
                                                >
                                                <ul
                                                    class="reactions-box dropdown-shadow"
                                                >
                                                    <li
                                        ...
                                        <a
                                            ...
                                            id="show-comments"
                                            ><i
                                                class="bx bx-message-rounded mr-2"
                                            ></i>
                                            5</a
                                        >
                                        <div
                                            class="dropdown dropup share-dropup"
                                        >
                                            <a
                                                href="#"
                                                class="post-card-buttons"
                                            ...
                                            >
                                                <i
                                                    class="bx bx-share-alt mr-2"
                                                ></i>
                                                Share
                                            </a>
                                            <div
                                                class="dropdown-menu post-dropdown-menu"
                                            >
                                                <a
                                                    href="#"
                                                    class="dropdown-item"
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <img
                                                                            :src="'/images/web/users/user-2.jpg'"
                                                                            alt=""
                                                                            class="img-circle"
                                                                        />
                                                                    </a>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <img
                                                                            :src="'//bootd/webey.com/img/Content/user_2.jpg'"
                                                                            alt=""
                                                                            class="img-circle"
                                                                        />
                                                                    </a>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <img
                                                                            :src="'//bootd/webey.com/img/Content/user_3.jpg'"
                                                                            alt=""
                                                                            class="img-circle"
                                                                        />
                                                                    </a>
