                                ...
                                <div class="col-md-12 profile-center">
                                    ...
                                    <div class="post border-bottom p-3 bg-white w-shadow">
                                        <div class="media text-muted pt-3">
                                            <img :src="'/images/web/users/user-4.jpg'" alt="Online user"
                                        ...
                                        <div class="d-block mt-3">
                                            <img :src="'/images/web/users/post/post-1.jpg'" class="w-100 mb-3"
                                                alt="post image" />
                                        </div>
                                        <div class="mb-2">
                                            <!-- Reactions -->
                                                                ...
                                                                <ul class="media-list comments-list">
                                                                    <li class="media comment-form">
                                                                        <a href="#" class="pull-left">
                                                                            <img :src="'/images/web/users/user-4.jpg'"
                                                                    ...
                                                                    <li class="media">
                                                                        <a href="#" class="pull-left">
                                                                            <img :src="'/images/web/users/user-2.jpg'"
                                                                                alt="" class="img-circle" />
                                                                        </a>
                                                                        <div class="media-body">
                                                                            <div
                                                                    ...
                                                                    <li class="media">
                                                                        <a href="#" class="pull-left">
                                                                            <img :src="'//bootd/webey.com/img/Content/user_2.jpg'"
                                                                                alt="" class="img-circle" />
                                                                        </a>
                                                                        <div class="media-body">
                                                                            <div
                                                                    ...
                                                                    <li class="media">
                                                                        <a href="#" class="pull-left">
                                                                            <img :src="'//bootd/webey.com/img/Content/user_3.jpg'"
                                                                                alt="" class="img-circle" />
                                                                        </a>
                                                                        <div class="media-body">
                                                                            <div
