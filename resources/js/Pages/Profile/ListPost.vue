<template>
    <Index :user="user">
    <Post v-if="isOwner"></Post>
        <div class="post border-bottom p-3 bg-white w-shadow">
            <div class="media text-muted pt-3">
                <img :src="'/images/web/users/user-4.jpg'" alt="Online user" class="mr-3 post-user-image" />
                <div class="media-body pb-3 mb-0 small lh-125">
                    ...
                    <span class="d-block">3 hours ago
            ...
            <div class="mt-3">
                <p>
                    ...
                    Quis voluptatem veritatis harum,
                    tenetur, quibusdam voluptatum,
                    incidunt saepe minus maiores ea
                    atque sequi illo veniam sint
                    quaerat corporis totam et.
                    Culpa?
                </p>
            </div>
            <div class="d-block mt-3">
                <img :src="'/images/web/users/post/post-1.jpg'" class="w-100 mb-3" alt="post image" />
            </div>
            <div class="mb-2">
                <!-- Reactions -->
                                    ...
                                    <ul class="media-list comments-list">
                                        <li class="media comment-form">
                                            <a href="#" class="pull-left">
                                                <img :src="'/images/web/users/user-4.jpg'" alt="" class="img-circle" />
                                            </a>
                                        ...
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img :src="'/images/web/users/user-2.jpg'" alt="" class="img-circle" />
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex justify-content-between align-items-center w-100">
                                        ...
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img :src="'//bootd/webey.com/img/Content/user_2.jpg'" alt=""
                                                    class="img-circle" />
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex justify-content-between align-items-center w-100">
                                        ...
                                        <li class="media">
                                            <a href="#" class="pull-left">
                                                <img :src="'//bootd/webey.com/img/Content/user_3.jpg'" alt=""
                                                    class="img-circle" />
                                            </a>
                                            <div class="media-body">
                                                <div class="d-flex justify-content-between align-items-center w-100">
