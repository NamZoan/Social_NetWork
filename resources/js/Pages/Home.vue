                        ...
                        <div class="media-body">
                            ...
                            <div class="row post-form-group">
                                <div class="col-md-9">
                                    ...
                                    >
                                        <img
                                            :src="'/images/web/icons/theme/post-image.png'"
                                            alt="post form icon"
                                        />
                                    ...
                                    >
                                        <img
                                            :src="'/images/web/icons/theme/tag-friend.png'"
                                            alt="post form icon"
                                        />
                                    ...
                                    >
                                        <img
                                            :src="'/images/web/icons/theme/check-in.png'"
                                            alt="post form icon"
                                        />
                                        <span>Check In</span>
                                    </button>
                    ...
                    <div class="post border-bottom p-3 bg-white w-shadow">
                        <div class="media text-muted pt-3">
                            ...
                            <div class="media-body pb-3 mb-0 small lh-125">
                                ...
                                <span class="d-block"
                                    >3 hours ago <i class="bx bx-globe ml-3"></i
                                ></span>
                            </div>
                        </div>
                        <div class="mt-3">
                            <p>
                                ...
                                adipisicing elit. Quis voluptatem veritatis
                                harum, tenetur, quibusdam voluptatum, incidunt
                                saepe minus maiores ea atque sequi illo veniam
                                sint quaerat corporis totam et. Culpa?
                            </p>
                        </div>
                            ...
                            <div class="argon-reaction">
                                <span class="like-btn">
                                    <a
                                        ...
                                        id="reactions"
                                        ><i class="bx bxs-like mr-2"></i> 67</a
                                    >
