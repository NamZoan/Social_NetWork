            ...
            <div class="signup-form">
                ...
                <form @submit.prevent="submitForm">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" class="form-control" v-model="form.phone" placeholder="Số điện thoại" />
                                <span v-if="form.errors.phone" class="text-danger small">{{ form.errors.phone }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span v-if="form.errors.day" class="text-danger small">{{ form.errors.day }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span v-if="form.errors.month" class="text-danger small">{{ form.errors.month }}</span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span v-if="form.errors.year" class="text-danger small">{{ form.errors.year }}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <input type="password" class="form-control" v-model="form.confirmPassword" placeholder="Xác nhận mật khẩu" />
                                <span v-if="form.errors.confirmPassword" class="text-danger small">{{ form.errors.confirmPassword }}</span>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <span class="go-login">Đã có tài khoản?
